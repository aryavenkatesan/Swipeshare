...
class AppColors {
  ...
  // Opacity variants
  static Color accentBlueLight = accentBlue.withOpacity(0.1);
  static Color accentBlueMedium = accentBlue.withOpacity(0.2);
  static Color accentBlueIndicator = accentBlue.withOpacity(0.3);
  static Color whiteTransparent = white.withOpacity(0.6);
